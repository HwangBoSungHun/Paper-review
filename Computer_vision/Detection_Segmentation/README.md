...
- Regressor의 Output IoU가 Input IoU보다 낫기 때문에 Cascade R-CNN의 각 stage는 __이전 stage의 output을 사용하여 순차적으로 학습(boostrapping과 유사함)__(Figure 1. (C))  
<img src = "./img/CascadeRCNN/intro.png" width="100%"></center>  
-   
## 2. Mask R-CNN
